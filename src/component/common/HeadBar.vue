    ...
    <div>
        <div class="Header">
            ...
            <div class="center-entry">
                <div class="box">
                    <div class="ShowBorder" :class="{ active_: Show1 }" @click="active1()">
                        <router-link :to="{ name: 'totalassessment' }" custom v-slot="{ navigate, isActive }">
                            <li @click="navigate" @keypress.enter="navigate" :class="{ active: isActive }" role="link">
                ...
                <div class="box">
                    <div class="ShowBorder" :class="{ active_: Show2 }" @click="active2()">
                        <router-link :to="{ name: 'judgeaward' }" custom v-slot="{ navigate, isActive }">
                            <li @click="navigate" @keypress.enter="navigate" :class="{ active: isActive }" role="link">
                ...
                <div class="box">
                    <div class="ShowBorder" :class="{ active_: Show3 }" @click="active3()">
                        <router-link :to="{ name: 'evaluation' }" custom v-slot="{ navigate, isActive }">
                            <li @click="navigate" @keypress.enter="navigate" :class="{ active: isActive }" role="link">
            ...
            <div class="right-entry">
                <div class="profile" @mouseenter="showPopupOnMouseEnter" @mouseleave="hidePopupOnMouseLeave">
...
.ShowBorder:before {
    ...
    width: 25%;
    height: 4px;
    background: linear-gradient(130.93deg,
